...
import ModernizationContent from './content'
...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    site: '@trenztech',
    title: 'Legacy System Modernization Services – Trenz Technologies',
    description: 'Bridge the gap between old and new. Scalable modernization solutions for enterprise systems.',
    creator: '@trenztech',
