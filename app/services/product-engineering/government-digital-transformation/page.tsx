...
import GovernmentProjectsContent from './content'

export const metadata: Metadata = {
  title: 'E-Governance & Government IT Projects | Trenz Technologies',
  ...
  twitter: {
    ...
    site: '@trenztech',
    title: 'E-Governance & Government IT Solutions – Trenz Technologies',
    description: 'End-to-end government IT project execution. Secure, compliant, and reliable citizen platforms.',
    creator: '@trenztech',
