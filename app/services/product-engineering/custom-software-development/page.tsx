...
import CustomSoftwareSaasContent from './content'
...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    site: '@trenztech',
    title: 'Custom Software & SaaS Development – Trenz Technologies',
    description: 'Expert custom software and SaaS development services. Scalable, secure, and built to perform.',
    creator: '@trenztech',
