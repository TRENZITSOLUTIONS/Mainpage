...
export const metadata: Metadata = {
  title: 'Web Application Development Services | Trenz Technologies',
  ...
  twitter: {
    ...
    site: '@trenztech',
    title: 'Web Application Development – Trenz Technologies',
    description: 'Scalable and responsive web applications built with the latest technologies. SEO-optimized and performance-driven.',
    creator: '@trenztech',
